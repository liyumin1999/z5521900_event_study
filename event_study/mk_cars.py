...
def mk_cars_df(ret_df, event_df):
    ...
    #DataFrame.apply method will apply a function to each column if axis = 0, or each row if axis = 1
...
if __name__ == "__main__":
    sample_only = True #includes only sample of single event, put on false to include the entire car
    # for all observations in dataframe
